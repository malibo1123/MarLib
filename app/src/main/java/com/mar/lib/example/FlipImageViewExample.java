...
import com.mar.lib.widget.FlipImageView;

public class FlipImageViewExample extends Activity implements FlipImageView.OnFlipListener,
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.example_flip_imageview);
