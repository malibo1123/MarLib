...
import com.mar.lib.physics.Physics;
import com.mar.lib.physics.PhysicsFrameLayout;
...
public class PhysicsExampleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.example_physics);
        ...
        addViewButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ImageView imageView = new ImageView(PhysicsExampleActivity.this);
                ...
                Picasso.with(PhysicsExampleActivity.this)
