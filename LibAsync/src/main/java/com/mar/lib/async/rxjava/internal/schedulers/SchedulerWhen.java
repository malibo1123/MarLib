 ...
 */
package com.mar.lib.async.rxjava.internal.schedulers;
...
import com.mar.lib.async.rxjava.disposables.Disposables;
import com.mar.lib.async.rxjava.exceptions.Exceptions;
import com.mar.lib.async.rxjava.functions.Function;
import com.mar.lib.async.rxjava.processors.FlowableProcessor;
import com.mar.lib.async.rxjava.processors.UnicastProcessor;
 ...
 * <p>
 * When the {@link com.mar.lib.async.rxjava.Scheduler.Worker Worker} is unsubscribed the {@link Completable} emits an
 ...
 * the number of concurrent {@link com.mar.lib.async.rxjava.Scheduler.Worker Worker}s rather than individual actions.
 * Generally each {@link Observable} uses its own {@link com.mar.lib.async.rxjava.Scheduler.Worker Worker}. This means
 * that this will essentially limit the number of concurrent subscribes. The
 * danger comes from using operators like
 * {@link Flowable#zip(org.reactivestreams.Publisher, org.reactivestreams.Publisher, com.mar.lib.async.rxjava.functions.BiFunction)} where
