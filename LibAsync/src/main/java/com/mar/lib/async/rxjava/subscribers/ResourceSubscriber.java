...
package com.mar.lib.async.rxjava.subscribers;

import java.util.concurrent.atomic.*;

import org.reactivestreams.Subscription;

import com.mar.lib.async.rxjava.FlowableSubscriber;
import com.mar.lib.async.rxjava.disposables.Disposable;
import com.mar.lib.async.rxjava.internal.disposables.ListCompositeDisposable;
...
import com.mar.lib.async.rxjava.internal.util.EndConsumerHelper;
 ...
 *
 * <p>Use {@link #add(Disposable)} to associate resources (as {@link com.mar.lib.async.rxjava.disposables.Disposable Disposable}s)
 ...
 * {@link com.mar.lib.async.rxjava.disposables.CompositeDisposable CompositeDisposable}, associate it with this
 ...
 * If for some reason this can't be avoided, use {@link com.mar.lib.async.rxjava.Flowable#safeSubscribe(org.reactivestreams.Subscriber)}
