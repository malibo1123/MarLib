...
package com.mar.lib.async.rxjava.flowables;
...
import com.mar.lib.async.rxjava.internal.util.ConnectConsumer;
...
public abstract class ConnectableFlowable<T> extends Flowable<T> {
     ...
     * {@link Flowable} to its {@link Subscriber}s.
     * <p>
     * To disconnect from a synchronous source, use the {@link #connect(com.mar.lib.async.rxjava.functions.Consumer)} method.
     *
